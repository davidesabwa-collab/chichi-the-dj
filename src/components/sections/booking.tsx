          ...
          <div>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:actualizeevents@gmail.com" className="block text-gray-400 hover:text-primary transition-colors">
                    actualizeevents@gmail.com
                  </a>
                  <a href="mailto:hi@chichithedj.us" className="block text-gray-400 hover:text-primary transition-colors">
                    hi@chichithedj.us
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8 flex items-start gap-3 bg-primary/5 border border-primary/20 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-400">
                <span className="text-white font-semibold">Booking Policy:</span> Reservations are first come, first served upon making a down payment. Your date is not secured until a deposit is received.
              </p>
            </div>
          </div>
